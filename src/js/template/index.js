...
import {cards_item} from "./modules/cards_item";
...
indiBlockController.add(swiper, ".js-swiper");
indiBlockController.add(header_burger, ".js-header_burger");
indiBlockController.add(cards_item, ".js-card_items");
indiBlockController.add(form, ".js-modal-form");
//
// Блоки проекта
//
